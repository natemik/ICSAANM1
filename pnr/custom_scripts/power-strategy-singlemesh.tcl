...
set M1_layer_idx 1
set M1_min_width    [dbGet [dbGetLayerByZ [expr $M1_layer_idx]].minWidth]
set M1_route_pitchX [dbGet [dbGetLayerByZ [expr $M1_layer_idx]].pitchX]
...
setAddStripeMode -stacked_via_bottom_layer [expr $M1_layer_idx] \
